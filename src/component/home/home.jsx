...
<section class="bg-white  mt:36 h-1200 custom:h-350">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-36 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7 ">
            ...
            <p class="max-w-2xl mb-6 ml-12 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"> I3-f Foundation , Indian Institute of Technology (BHU) Varanasi</p>
