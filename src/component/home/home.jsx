  ...
  return (
    <div className="text-center relative ">
      ...
      <div className="absolute top-[100px] md:top-[200px] lg:top-[250px]  left-[50%] transform translate-x-[-50%] flex flex-col items-center justify-center xl:w-[900px]">
        ...
        <p className="text-white text-center mb-4">I-3f Foundation, Indian Institute of Technology (BHU) Varanasi</p>
        <div className="flex justify-center">
          <Link className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base border bg-gray-400 font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900" to="/">
