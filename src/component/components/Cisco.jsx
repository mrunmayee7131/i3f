    ...
    <div class="mx-auto grid gap-5 md:w-3/4 lg:w-full lg:grid-cols-3">
      <div class="border border-white-100 dark:border-white-700 rounded-3xl bg-white dark:bg-white-800 px-8 pt-12 shadow-2xl shadow-gray-600/10 dark:shadow-none sm:px-12 lg:px-25">
        <div class="mb-2 space-y-2">
          <h3 class="text-2xl font-semibold text-gray-800 dark:text-black">AI & IoT</h3>
        </div>
        <img
          src={ai}
          class="ml-auto w-2/3"
      ...
      <div class="border border-white-100 dark:border-white-700 rounded-3xl bg-white dark:bg-white-800 px-8 pt-12 shadow-2xl shadow-gray-600/10 dark:shadow-none sm:px-12 lg:px-25">
        <div class="mb-2 space-y-4">
          <h3 class="text-2xl font-semibold text-gray-800 dark:text-black">Machine Learning</h3>
        </div>
        <img
          src={ml}
          class="ml-auto w-2/3"
      ...
      <div class="border border-white-100 dark:border-white-700 rounded-3xl bg-white dark:bg-white-800 px-8 pt-12 shadow-2xl shadow-gray-600/10 dark:shadow-none sm:px-12 lg:px-25">
        <div class="mb-2 space-y-4">
          <h3 class="text-2xl font-semibold text-gray-800 dark:text-black">Engineering</h3>
        </div>
        <img
          src={eng}
          class="ml-auto w-2/3"
