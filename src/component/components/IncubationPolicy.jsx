...
function Ip(){
  ...
  Incubation Policy
      ...
      <h4 class="text-center text-black">General Policy Guidelines:</h4><br></br>
...
<div class="relative overflow-x-auto">
    <table class="w-full text-sm text-left  text-black-600 dark:text-black-300">
        <thead class="text-black-600 dark:text-black-300 uppercase bg-black-50 dark:bg-black-700 dark:text-black-400">
            <tr>
                ...
                <th scope="col" class="px-6 py-3">
                Virtual Incubation Charges<br></br>
(Rs. per month)
                </th>
                <th scope="col" class="px-6 py-3">
                Physical Incubation Charges<br></br>
(Rs. per month)
                </th>
                <th scope="col" class="px-6 py-3">
                Utility & Equipment Charges<br></br>
(Rs.)
                </th>
            </tr>
        </thead>
        <tbody>
            <tr class="bg-white border-b dark:bg-white-800 dark:border-gray-700">
                <th scope="row" class="px-6 py-4 text-xl text-gray-900 whitespace-nowrap dark:text-black">
...
<br></br>
<br></br>
<div class="text-center">Intellectual Property & Operation Information:</div><br></br>
...
<br></br>
4. The term “Operational Information” shall include materials or information:<br></br><br></br>
<div class="ml-20">
...
<br></br>
<br></br>
<div class="text-center">Publications:</div><br></br>
...
<br></br>
<br></br>
<div class="text-center">Termination of Contract:</div><br></br>
...
<br></br><br></br>
<div class="text-center">Governing Law & Arbitration:</div><br></br>
...
<br></br>
2. The company agrees to take appropriate insurance to cover all liabilities arising out of accidents or otherwise coverage for its staff and property at its cost. The incubator has no liability for the company’s staff and property.<br></br>
      </p>
      </div>
      </div>
      <Footer></Footer>
