...
function Rabi(){
  ...
  RKVY-RAFTAAR AGRI BUSINESS INCUBATOR (R-ABI)
      ...
      <p class="my-10 font-thin text-black-600 dark:text-black-300 lg:mx-auto lg:w-8/12">
  ...
  <div class="xl:container">
    ...
    <a
          ...
          >
            <span
              class="relative flex items-center justify-center text-base font-semibold text-sky-600 dark:text-white"
              >Explore more </span>
        </a>
        </div></div>
      </div>
