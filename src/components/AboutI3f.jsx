...
function Abti3f(){
    return(
        ...
        <h2 className="header">Our Mission:</h2><br></br>
        <p className="content">Identifying, exploring, and developing regional competitiveness, enhancing links between universities and research institutions, and contributing to the growth and success of emerging technology businesses.</p><br></br>
        <h2 className="header">Our Vision:</h2><br></br>
        <p className="content">Contributing to raising the GDP of our National Economy through Entrepreneurship, – initiating start-ups and supporting SMEs in the East UP region.</p><br></br>
        <h2 className="header">Our Objectives:</h2><br></br>
        <p className="content">I3F has been established with the following objectives-</p><br></br>
